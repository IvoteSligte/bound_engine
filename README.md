# Bound Engine
An incomplete 3D light simulation engine implemented in Vulkan.
...
Eventually I started exploring other research areas due to frustration with shader programming, and particularly the lack of debugging capabilities of GLSL.

The many branches contain some number of the attempts I made. I only started getting into git when I was working on this project, so the layout and branching is quite messy.
